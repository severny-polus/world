...
var $author$project$Projection$init = _Utils_Tuple2(
	{
		ai: $author$project$Projection$initAngle,
		aK: 0,
		Y: 0,
...
var $author$project$Projection$initAngleVelocity = ($elm$core$Basics$pi / 12) / 60;
var $author$project$Projection$maxShowParam = 1;
var $author$project$Projection$maxShowParamAcceleration = 5;
				...
				return _Utils_Tuple2(
					function () {
						if (!projection.U) {
							return _Utils_update(
								projection,
								{ai: projection.ai + (projection.Y * dt), Y: projection.Y + (projection.aK * dt)});
						} else {
							var showParam = projection.J + (projection.ad * dt);
							return (_Utils_cmp(showParam, $author$project$Projection$maxShowParam) < 0) ? _Utils_update(
								projection,
								{
									...
									ad: projection.ad + (projection.U * dt)
								}) : _Utils_update(
								projection,
								{Y: $author$project$Projection$initAngleVelocity, J: $author$project$Projection$maxShowParam, U: 0, ad: 0});
						}
					}(),
					$elm$core$Platform$Cmd$none);
		}
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.b$]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.cf]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.c2]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.c0]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.cO]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.dj, $mdgriffith$elm_ui$Internal$Style$classes.ce]));
						}
					}())
				]),
			_List_fromArray(
...
var $author$project$Projection$view = function (projection) {
	var z = projection.aG / (2 - projection.J);
	...
	var rotate = function (_v4) {
		...
		var theta = _v4.b;
		return _Utils_Tuple2(
			(phi + projection.ai) - (($elm$core$Basics$pi / 3) * (1 - $elm$core$Basics$sqrt(projection.J))),
			theta);
	};
	...
	var transformTheta = function (theta) {
		return (z * r(theta / z)) / r($elm$core$Basics$pi / projection.aG);
	};
