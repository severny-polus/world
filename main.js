...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{anglePerSecond: (2 * $elm$core$Basics$pi) / 360, flags: flags, projection: $elm$core$Maybe$Nothing},
		A2(
			$elm$core$Task$perform,
			A2(
...
var $author$project$GeoJson$toPolygon = function (feature) {
	...
	var interiors = $elm$core$List$tail(feature.geometry.coordinates);
	var exterior = $elm$core$List$head(feature.geometry.coordinates);
	return A3(
		$elm$core$Maybe$map2,
...
var $author$project$GeoJson$toPolygons = function (data) {
	return $elm_community$maybe_extra$Maybe$Extra$combine(
		A2($elm$core$List$map, $author$project$GeoJson$toPolygon, data.features));
};
...
var $author$project$Projection$init = F3(
	function (size, land, antarctica) {
		return {angle: 0, antarctica: antarctica, land: land, size: size};
	});
							...
							model,
							{
								projection: A3(
									...
									$author$project$Projection$init(
										_Utils_Tuple2(scene.width, scene.height)),
									$author$project$Main$getGeodata(
										A2($elm$core$Debug$log, 'noAntarctica', model.flags.landWithoutAntarctica)),
									$author$project$Main$getGeodata(
										A2($elm$core$Debug$log, 'antarctica', model.flags.antarctica)))
							});
					case 'Resize':
						var width = msg.a;
						var height = msg.b;
						...
						return _Utils_update(
							model,
							{
								projection: A2(
									$elm$core$Maybe$map,
									$author$project$Projection$update(
										$author$project$Projection$AngleChange((model.anglePerSecond * ms) / 1000)),
									model.projection)
							});
					default:
						return model;
...
var $author$project$Projection$view = function (projection) {
	...
	var rotate = function (_v2) {
		var phi = _v2.a;
		var theta = _v2.b;
		return _Utils_Tuple2(phi + projection.angle, theta);
	};
	var a = A2($elm$core$Basics$min, projection.size.a, projection.size.b);
		...
		return $elm$core$List$concat(
			_List_fromArray(
				[
					...
					A2($elm$core$List$map, interior, pol.interiors)
				]));
	};
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					...
					A2($elm$core$List$concatMap, outerPolygons, projection.antarctica),
					A2($elm$core$List$concatMap, polygons, projection.land)
				])));
};
					...
					return A2(
						...
						function (antarctica) {
							return $elm$json$Json$Decode$succeed(
								{antarctica: antarctica, end: end, landWithoutAntarctica: landWithoutAntarctica});
						},
						A2($elm$json$Json$Decode$field, 'antarctica', $elm$json$Json$Decode$string));
				},
